...
export default function AddNew() {
  ...
  const add_new_card = require("../Assests/add_new_habit_card.png");
  ...
  return (
    // This page Display the form to add new habitflex justify-end items-center 
    <div className="home-page  px-3 md:pr-[20%] ">
      <div className="mobile-design">
        <div className="p-5">
          {/* Heading for Start New Habit */}

          <div className="text-xl font-bold">Add Your New Habit</div>

          <img src={add_new_card} className="h-40 w-full" alt="Add New Card" />
          ...
          >
            ...
            <div className="flex justify-center mt-4">
              ...
              <button
                type="submit"
                className={`h-12 w-1/2 bg-blue/** @type {import('tailwindcss').Config} */
                module.exports = {
                  content: [
                    "./src/**/*.{js,jsx,ts,tsx}",
                  ],
